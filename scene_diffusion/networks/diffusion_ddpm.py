...
class GaussianDiffusion:
    ...
    def p_losses(self, denoise_fn, data_start, t, noise=None, condition=None, condition_cross=None, disMat=None):
        """
...
#this so-called "DiffusionPoint" combined the "GaussianDiffusion" and the "denoise_net" together
    #the "GaussianDiffusion" create noisy sample and  calculate the losses between two "clear" sample_params
    #the "denoise_net" reconstruct the sample_param from a noisy one (usually UNet1D)
class DiffusionPoint(nn.Module):
    ...
    def get_loss_iter(self, data, noises=None, condition=None, condition_cross=None, wallTensor=None, windoorTensor=None, disMat=None):
        ...
        losses, loss_dict = self.diffusion.p_losses(
            denoise_fn=self._denoise, data_start=data, t=t, noise=noises, condition=condition, condition_cross=condition_cross, disMat=disMat)
