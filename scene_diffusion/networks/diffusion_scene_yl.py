...
class DiffusionSceneYL(Module):
    #prepare the basic models and properties of this training task 
    #deep learning models in lower level does not knows "scene synthesis", only knows diffusion
    ...
    #evaluate if the deep learning model inside this module can reconstruct these sample_params
    ...
    #reconstruct a reasonable "sample_params" from a random seed: the following 4 functions called this one
